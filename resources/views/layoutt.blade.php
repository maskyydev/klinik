...
<body class="font-sans bg-gray-100 flex flex-col lg:flex-row">
    ...
    <!-- Sidebar -->
    <aside id="sidebar" class="h-screen w-64 flex-shrink-0 hidden lg:block animate__animated animate__fadeInLeft bg-white">
        <div class="p-4 bg-white">
            <h1 class="text-2xl font-semibold text-black">Menu</h1>
        </div>
        <nav class="space-y-2 py-4 ml-auto">
            <a href="{{ url('/home') }}" class="block pl-4 pr-2 py-2 text-sm font-medium text-black hover:bg-gray-200 transition duration-300 animate__animated animate__fadeInLeft">Dashboard</a>
            <a href="{{ url('pasien/antrian') }}" class="block pl-4 pr-2 py-2 text-sm font-medium text-black hover:bg-gray-200 transition duration-300 animate__animated animate__fadeInLeft">Data Pendaftar</a>
            <a href="{{ url('/detail') }}" class="block pl-4 pr-2 py-2 text-sm font-medium text-black hover:bg-gray-200 transition duration-300 animate__animated animate__fadeInLeft">Detail Pasien</a>
            <div id="transaksiDropdown" class="relative">
                ...
                <div id="dropdownContent" class="hidden ml-5 absolute left-0 top-8 border-gray-300 p-2 rounded animate__animated animate__fadeInLeft">
                    <a href="{{ url('/obat') }}" class="block pl-4 pr-2 py-2 text-sm font-medium text-black hover:bg-gray-200 transition duration-300 animate__fadeInLeft">Detail Obat</a>
                    <a href="{{ url('/riwayat') }}" class="block pl-4 pr-2 py-2 text-sm font-medium text-black hover:bg-gray-200 transition duration-300 animate__fadeInLeft">Riwayat Obat Terjual</a>
                    <a href="{{ url('/obatmasuk') }}" class="block pl-4 pr-2 py-2 text-sm font-medium text-black hover:bg-gray-200 transition duration-300 animate__fadeInLeft">Riwayat Obat Masuk</a>
                    <a href="{{ url('/riwayatpasien') }}" class="block pl-4 pr-2 py-2 text-sm font-medium text-black hover:bg-gray-200 transition duration-300 animate__fadeInLeft">Riwayat Data Pendaftar</a>
                    <a href="{{ url('/riwayatpembayaran') }}" class="block pl-4 pr-2 py-2 text-sm font-medium text-black hover:bg-gray-200 transition duration-300 animate__fadeInLeft">Riwayat Pembayaran</a>
                </div>
            </div>
        </nav>
